...
STOPWORDS += [
    ...
    'Ljubljana',
    'mesten',
    'Na', # intentionally capitalized; `na` is already in the main list, this is lemmatized as `Na` because it looks like the chemical symbol for sodium
    'oziroma',
    'pač',
    'predlog'
    'reči',
