from parlacards.scores.attendance import (
    save_people_vote_attendance,
    save_groups_vote_attendance,
)
...
from parlacards.scores.number_of_questions import (
    save_people_number_of_questions,
    save_group_number_of_questions,
)
...
def run_analyises_for_new_data(timestamp=None):
    ...
    motion_playing_fields = new_motions.distinct("session__organizations").values_list(
        "session__organizations", flat=True
    )
    ...
    question_playing_fields = [
        ...
        for person_membership in person_memberships_of_questions
    ]
